		...
		<div>
			<?php if ( $attributes['title'] ) : ?>
				<?php if ( $attributes['url'] && ! empty( $attributes['url'] ) ) : ?>
					<a class="beta u-link-area color-cyberspace" href="<?php echo esc_url( $attributes['url'] ); ?>" <?php echo ( $attributes['newWindow'] ) ? 'target="_blank"' : '' ?>><?php echo esc_html( $attributes['title'] ); ?></a>
				<?php else : ?>
