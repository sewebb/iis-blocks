			...
			>
				...
				c-2.2,1.8-5.1,2.8-8.2,2.8c-0.5,0-1.1,0-1.6-0.1c2.9,1.9,6.4,3,10.1,3c12.1,0,18.6-10,18.6-18.6V6.6C30,5.5,31.1,4.4,32,3.1L32,3.1z"
					...
					<symbol id="icon-mute" viewBox="0 0 32 32">
						...
						/>
						<path className="cls-1" transform="rotate(-45 25.758 16)" d="M24.76 10h2v12h-2z" />
						<path className="cls-1" transform="rotate(-45 25.758 16)" d="M19.76 15h12v2h-12z" />
					</symbol>
					...
					<symbol id="icon-2g" viewBox="0 0 32 32">
						...
						<text transform="translate(2.72 9.396)" className="u-weight-bolder" fontSize="9">2G</text>
					</symbol>
					<symbol id="icon-3g" viewBox="0 0 32 32">
						<path d="M24 3h5v26h-5V3zm-7 7h5v19h-5V10zm-7 7h5v12h-5V17zm-7 7h5v5H3v-5z" />
						<text transform="translate(2.72 9.396)" className="u-weight-bolder" fontSize="9">3G</text>
					</symbol>
					<symbol id="icon-4g" viewBox="0 0 32 32">
						<path d="M24 3h5v26h-5V3zm-7 7h5v19h-5V10zm-7 7h5v12h-5V17zm-7 7h5v5H3v-5z" />
						<text transform="translate(2.72 9.396)" className="u-weight-bolder" fontSize="9">4G</text>
					</symbol>
					<symbol id="icon-5g" viewBox="0 0 32 32">
						<path d="M24 3h5v26h-5V3zm-7 7h5v19h-5V10zm-7 7h5v12h-5V17zm-7 7h5v5H3v-5z" />
						<text transform="translate(2.72 9.396)" className="u-weight-bolder" fontSize="9">5G</text>
					</symbol>
					...
					<symbol id="icon-spinner" viewBox="0 0 100 100" className="spinner">
						<g>
							<circle cx="50" cy="50" fill="none" r="43" stroke="#50b2fc" strokeWidth="7" />
							<circle
								cx="50"
								cy="50"
								fill="none"
					...
					<symbol id="icon-spinner-white" viewBox="0 0 100 100" className="spinner">
						<g>
							<circle cx="50" cy="50" fill="none" r="43" stroke="none" strokeWidth="7" />
							<circle
								cx="50"
								cy="50"
								fill="none"
