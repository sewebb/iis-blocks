...
var _DataSelect = __webpack_require__(8);
...
registerBlockType('iis/puff', {
	...
	edit: function edit(_ref) {
		...
		useEffect(function () {
			wp.apiFetch({ path: '/wp/v2/posts?parent=0&per_page=-1' }).then(function (fetchedPosts) {
				// Make posts in options format.
				var postOptions = fetchedPosts.map(function (post) {
					return {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					!custom && React.createElement(SelectControl, {
						label: __('Post', 'iis'),
