...
/* harmony import */ var _blocks_Selectable__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./blocks/Selectable */ "./src/js/blocks/Selectable.jsx");
/* harmony import */ var _blocks_SelectableItem__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./blocks/SelectableItem */ "./src/js/blocks/SelectableItem.jsx");
/* harmony import */ var _blocks_SelectableItem__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(_blocks_SelectableItem__WEBPACK_IMPORTED_MODULE_25__);
...
var enableToolbarButtonOnBlocks = ['core/separator'];
...
registerBlockType('iis/card', {
  ...
  edit: function edit(_ref) {
    ...
    return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
      ...
      onChange: function onChange(figcaption) {
        return setAttributes({
...
/***/ "./src/js/blocks/HeightLimiter.jsx":
/*!*****************************************!*\
  !*** ./src/js/blocks/HeightLimiter.jsx ***!
  \*****************************************/
/***/ (() => {
...
registerBlockType('iis/height-limiter', {
  ...
  edit: withColors({
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelColorSettings, {
      ...
      type: "text",
      label: __('Maximize text'),
      value: attributes.maximize_text,
      onChange: function onChange(maximize_text) {
        return setAttributes({
          maximize_text: maximize_text
        });
      }
    }), /*#__PURE__*/React.createElement(TextControl, {
      type: "text",
      label: __('Minimize text'),
      value: attributes.minimize_text,
      onChange: function onChange(minimize_text) {
        return setAttributes({
...
registerBlockType('iis/hero', {
  ...
  edit: withColors({
    ...
    React.createElement("iframe", {
    ...
    }), attributes.layout !== 'dynamic' && attributes.layout !== 'no-break' && /*#__PURE__*/React.createElement(RichText, {
      tagName: "span",
      value: attributes.pretitle,
      placeholder: __('Pre title'),
      onChange: function onChange(pretitle) {
      ...
      allowedBlocks: ['iis/button']
    }))), attributes.layout === 'no-break' && /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(RichText, {
      tagName: "p",
      value: attributes.introText,
      placeholder: __('Content'),
      onChange: function onChange(introText) {
...
registerBlockType('iis/info', {
  ...
  edit: function edit(_ref) {
    var attributes = _ref.attributes,
      setAttributes = _ref.setAttributes;
    var allowed = ['core/paragraph', 'core/heading', 'core/list', 'core/image'];
    var template = [];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _selectable_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./selectable.css */ "./src/js/blocks/selectable.css");
...
registerBlockType('iis/selectable', {
  ...
  edit: function edit(_ref) {
    var attributes = _ref.attributes,
      setAttributes = _ref.setAttributes;
    return /*#__PURE__*/React.createElement("div", {
      className: "iis-block-selectable"
    }, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(ToggleControl, {
      label: "Wrapped",
      ...
      onChange: function onChange(transparent) {
        return setAttributes({
      ...
      onChange: function onChange(rounded) {
        return setAttributes({
          rounded: rounded
        });
      }
...
/***/ "./src/js/blocks/SelectableItem.jsx":
/*!******************************************!*\
  !*** ./src/js/blocks/SelectableItem.jsx ***!
  \******************************************/
/***/ (() => {
...
registerBlockType('iis/tabs', {
  ...
  edit: function edit(_ref) {
    ...
    }, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(TextControl, {
...
registerBlockType('iis/visualization', {
  ...
  edit: withColors({
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(CheckboxControl, {
      label: __('No padding'),
      checked: attributes.padding === '--no-padding',
      onChange: function onChange(value) {
        return setAttributes({
          padding: value ? '--no-padding' : ''
        });
      }
    }), /*#__PURE__*/React.createElement(TextControl, {
      label: __('URL'),
    ...
    }), attributes.link && /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(CheckboxControl, {
      label: __('Open in new window'),
      checked: attributes.target === '_blank',
      onChange: function onChange(value) {
        return setAttributes({
...
var DataSelect = /*#__PURE__*/function (_Component) {
  function DataSelect() {
    ...
    _this = _callSuper(this, DataSelect, [].concat(args));
    ...
    _defineProperty(_this, "searchThrottle", null);
    _defineProperty(_this, "fetch", function () {
      _this.setState({
        loading: true,
        error: false
      });
  ...
  return _createClass(DataSelect, [{
...
var IconSelect = withState({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, !value && /*#__PURE__*/React.createElement(Button, {
    ...
    d: "M32 16c0-8.8-7.2-16-16-16S0 7.2 0 16s5.2 13.8 12.1 15.5V20.9H8.8V16h3.3v-2.1c0-5.4 2.5-8 7.8-8s2.8.2 3.5.4v4.4h-1.8c-2.6 0-3.6 1-3.6 3.6V16h5.2l-.9 4.9H18v11c7.9-1 14.1-7.7 14.1-15.9Z"
  })), /*#__PURE__*/React.createElement("symbol", {
    id: "icon-instagram",
    viewBox: "0 0 32 32"
  }, /*#__PURE__*/React.createElement("path", {
    ...
    id: "icon-step-backwards",
    viewBox: "0 0 32 32"
  }, /*#__PURE__*/React.createElement("path", {
    d: "m25.7 28.9-14.2-13 14.2-13v26zM9.753 28h-5V3h5z"
  })), /*#__PURE__*/React.createElement("symbol", {
    id: "icon-play",
    viewBox: "0 0 32 32"
  }, /*#__PURE__*/React.createElement("path", {
    ...
    id: "icon-step-forwards",
    viewBox: "0 0 32 32"
  }, /*#__PURE__*/React.createElement("path", {
    d: "m4.8 2.9 14.2 13-14.2 13v-26zM20.7 3.1h5v25h-5z"
  })), /*#__PURE__*/React.createElement("symbol", {
    id: "icon-forward-60",
    viewBox: "0 0 32 32"
  }, /*#__PURE__*/React.createElement("path", {
    ...
    d: "M27 10v12H5V10h22m3-3H2v18h28V7z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M25 19h-4"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M21 18h4v2h-4z"
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./src/js/blocks/selectable.css":
/*!************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./src/js/blocks/selectable.css ***!
  \************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_selectable_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!../../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./selectable.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./src/js/blocks/selectable.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_selectable_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_selectable_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
